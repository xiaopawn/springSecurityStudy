...
import com.pawn.jwtserver.config.auth.*;
import com.pawn.jwtserver.config.auth.imagecode.CaptchaFilter;
import com.pawn.jwtserver.config.auth.smscode.SmsCodeSecurityConfig;
...
//                .defaultSuccessUrl("/index")
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/login.html","/login", "/getCaptchaCode","/getSmsCode","/smslogin","/logoutSuccessUrl.html").permitAll()
